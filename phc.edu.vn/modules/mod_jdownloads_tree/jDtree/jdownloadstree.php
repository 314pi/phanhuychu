...
* -----------------------------------------------------------------------------------------------------
* Modified for jDownloads 1.8 by Arno Betz
* 
*/
// no direct access
...
class jdownloadstree{
  ...
  .jdmcredits {
	...
	*/
	...
	function addToArray($id,$name,$parentID,$url="",$target="",$imageIcon="modules/mod_jdownloads_tree/jDtree/images/folder.gif"){
        ...
        if(isset($this->elementArray[$parentID])){			
			...
			for($no=0;$no<count($this->elementArray[$parentID]);$no++){
				...
				if ($this->elementArray[$parentID][$no][0] != $catid){
                  ...
                  echo "<li class=\"j7dctree_node\"><img height=\"18\" width= \"18\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jDtree/images/plus.gif\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[$parentID][$no][4]."\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[$parentID][$no][1]."</a>";    
                } else { 
                  echo "<li class=\"j7dctree_node\"><img height=\"18\" width= \"18\" class=\"tree_plusminus\" id=\"plusMinus".$this->elementArray[$parentID][$no][0]."\" src=\"modules/mod_jdownloads_tree/jDtree/images/plus.gif\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[$parentID][$no][4]."\">".$this->elementArray[$parentID][$no][1];      
                }  
	...
	function drawTree($home_link){
        $catid = intval(JArrayHelper::getValue($_REQUEST, 'catid', 0));
        echo '<div id="docmantree" class="moduletable'.$moduleclass_sfx.'">';               
		echo "<ul id=\"docmantreetopNodes\" class=\"j7dctree\">";
		...
		for($no=0;$no<count($this->elementArray[0]);$no++){
            ...
            if ($this->elementArray[0][$no][0] != $catid){
			    ...
			    echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jDtree/images/plus.gif\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[0][$no][4]."\"><a class=\"j7dctree_link\"$urlAdd>".$this->elementArray[0][$no][1]."</a>";		
            } else {
                 echo "<li onmouseover=\"this.className='jdmroothov'\" onmouseout=\"this.className='j7dctree_node'\" class=\"j7dctree_node\" id=\"node_".$this->elementArray[0][$no][0]."\"><img height=\"18\" width= \"18\" id=\"plusMinus".$this->elementArray[0][$no][0]."\" class=\"tree_plusminus\" src=\"modules/mod_jdownloads_tree/jDtree/images/plus.gif\"><img height=\"16\" width= \"16\" src=\"".$this->elementArray[0][$no][4]."\">".$this->elementArray[0][$no][1];        
            }     
