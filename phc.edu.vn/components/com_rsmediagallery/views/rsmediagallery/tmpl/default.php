		...
		<ul id="rsmg_gallery">
			...
			<li>
				<div class="rsmg_item_container">
					<a class="rsmg_lightbox" <?php if ($this->params->get('open_in_new_page', 0)) { ?>target="_blank"<?php } ?> href="<?php echo $item->href; ?>" rel="{'link': '<?php echo addslashes($item->full); ?>', 'title': '#rsmg_item_<?php echo $i; ?>', 'id': '<?php echo $item->id; ?>'}" title=""><img src="<?php echo $item->thumb; ?>" alt="<?php echo $this->escape($item->title); ?>" /></a>
